...
use ../data/final_data/anal_doctor_y10_assumption


merge 1:1 y10 using  ../data/final_data/anal_law_y10_assumption, gen(merge_law)
merge 1:1 y10 using  ../data/final_data/anal_officers_y10_assumption, gen(merge_army)
merge 1:1 y10 using  ../data/final_data/anal_bus_y10_assumption.dta, gen(merge_business)
merge 1:1 y10 using  ../data/final_data/anal_reps_y10_assumption, gen(merge_reps)
...
twoway (connected `drvar' y10 if y10<1925, `doctors' ) ///
		...
		(connected relative_rep_noble_hun_bus y10 if y10<1925, `business' ) ///
			(connected relative_rep_noble_reps y10 if y10<1925, `mps' ) ///
,     text(0.5 1895 "Austria-Hungary", place(c) size(small)) text(0.5 1933 "Fascism", place(c) size(small)) ///
	text(0.5 1967 "Communism", place(c) size(small)) text(0.5 2005 "3rd Republic", place(c) size(small)) ///
legend(order(1 "Medical students" 2 "Law students" 3 "Managers" 4 "Members of Parliament") pos(6) row(2) col(2)) ///
...
ytitle("Relative representation") title("-y names") subtitle("Average over a decade")  xtitle("Decade") 

graph export ../figures/milan_ynames1.pdf, replace
graph export ../figures/milan_ynames1.png, replace
...
(connected `drvar' y10 if y10==1925|y10==1935|y10==1945 , `doctors') ///
		...
		(connected relative_rep_noble_hun_bus y10  if y10==1925|y10==1935|y10==1945, `business') ///
...
graph export ../figures/milan_ynames2.pdf, replace
graph export ../figures/milan_ynames2.png, replace
...
(connected `drvar' y10 if y10==1925|y10==1935|y10==1945 , `doctors') ///
		...
		(connected relative_rep_noble_hun_bus y10  if y10>1945&y10<1995, `business') ///
...
graph export ../figures/milan_ynames3.pdf, replace
graph export ../figures/milan_ynames3.png, replace
...
(connected `drvar' y10 if y10==1925|y10==1935|y10==1945 , `doctors') ///
		...
		(connected relative_rep_noble_hun_bus y10  if y10>=1995, `business') ///
...
graph export ../figures/milan_ynames.pdf, replace
graph export ../figures/milan_ynames.png, replace
...
,     text(0 1895 "Austria-Hungary", place(c) size(small)) text(0 1933 "Fascism", place(c) size(small)) ///
...
ytitle("Relative representation") title("Top20 most frequent names") subtitle("Average over a decade")  xtitle("Decade")

graph export ../figures/milan_top20_1.pdf, replace
graph export ../figures/milan_top20_1.png, replace
...
graph export ../figures/milan_top20_2.pdf, replace
graph export ../figures/milan_top20_2.png, replace
...
graph export ../figures/milan_top20_3.pdf, replace
graph export ../figures/milan_top20_3.png, replace
...
graph export ../figures/milan_top20.pdf, replace
graph export ../figures/milan_top20.png, replace
