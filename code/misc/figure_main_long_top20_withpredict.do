...
twoway 	(lfit `drvar' y10 if y10<1925&y10>=1840, `doctors_pred' range(1870 2020) ) ///
        ...
        (lfit `busvar' y10 if y10<1925&y10>=1870, `business_pred' range(1870 2020)) ///
        (lfit `repvar' y10 if y10<1925&y10>=1870, `mps_pred' range(1870 2020)) ///
		(lfit `officervar' y10 if y10<1925&y10>=1870, `officers_pred' range(1870 2020) ) ///
...
,     text(0 1895 "Austria-Hungary", place(c) size(small)) text(0.1 1933 "Horthy-", place(c) size(small))  text(0 1933 "regency", place(c) size(small)) ///lace(c) size(small)) ///
...
ytitle("Relative representation") title("Top 20 most frequent names") subtitle("Decade averages")  xtitle("Decade") ///
