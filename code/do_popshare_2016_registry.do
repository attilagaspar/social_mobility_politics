import excel "../../social mobility (1)/data_forpublication/raw/2016_CSALADINEV.xlsx", sheet("stata") firstrow clear
...
save "$population_control_data_dir/pop_y2016_year.dta" , replace
restore

gen y5= floor(year/5)*5

do collapse_withweight.do count y5
save "$population_control_data_dir/pop_y2016_y5.dta" , replace
