...
use "../../social mobility (1)/data/census1720/namelist_1720.dta", clear
...
gen y5 = 1720
gen y10 = 1720
save "../../social mobility (1)/data/census1720/namelist_1720_groups_alternative.dta", replace



preserve
	do collapse_withoutweight_1720 year
	save "$population_control_data_dir/pop_y1720_year.dta" , replace
restore, preserve
	do collapse_withoutweight_1720 y5
	save "$population_control_data_dir/pop_y1720_y5.dta" , replace
restore, preserve
	do collapse_withoutweight_1720 y10
	save "$population_control_data_dir/pop_y1720_y10.dta" , replace
